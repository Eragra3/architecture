...
namespace KekManager.Database.Migrations
{
    ...
    [Migration("20180701122356_AddedSubjectKekPek")]
    partial class AddedSubjectKekPek
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("KekManager.Data.Models.KekModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("KekManager.Data.Models.PekModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("KekManager.Data.Models.SubjectKekJoinModel", b =>
                {
                    b.Property<int>("KekId");

                    b.Property<int>("SubjectId");

                    b.HasKey("KekId", "SubjectId");

                    b.HasIndex("SubjectId");

                    b.ToTable("SubjectKekJoinModel");
                });

            modelBuilder.Entity("KekManager.Data.Models.SubjectModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.HasData(
                        new { Id = 1, Name = "Teleinformatyka", SupervisorId = 3 },
                        new { Id = 2, Name = "Algorytmy i Struktury Danych", SupervisorId = 1 },
                        new { Id = 3, Name = "Projektowanie Systemów Informatycznych II" },
                        new { Id = 4, Name = "Analiza Matematyczna I" }
                    );
                });
            ...
            modelBuilder.Entity("KekManager.Data.Models.PekModel", b =>
                {
                    b.HasOne("KekManager.Data.Models.KekModel", "Kek")
                        .WithMany("Peks")
                        .HasForeignKey("KekId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("KekManager.Data.Models.SubjectModel", "Subject")
                        .WithMany("Peks")
            ...
            modelBuilder.Entity("KekManager.Data.Models.SubjectModel", b =>
                {
                    b.HasOne("KekManager.Data.Models.ResearchFellowModel", "Supervisor")
                        .WithMany()
